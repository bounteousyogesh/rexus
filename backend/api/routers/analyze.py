...
async def analyze_ticket(request: Request, req: AnalyzeRequest):
    ...
    kb_pdf_cache: dict[str, bytes | None] = {}
    ...
    focused_playbook = None
    if kb_articles:
        focused_playbook = await _generate_kb_playbook_summary(
            cleaned_issue,
            incident_number,
            kb_articles,
            pool,
    ...
    focused_playbook["kb_articles"] = kb_articles
